      ...
      <?php
        while($row = $result->fetch_assoc()){
          echo "  <div class=\"row forms\">
              <div class=\"col-md-8\"><a href=\"feedback_edit_form.php?id=".$row['f_id']."\">".$row['form_name']."</a></div>
              <div class=\"col-md-4\"><span class=\"glyphicon glyphicon-remove remove\" data-value=\"".$row['f_id']."\"> </span>
              <span class=\"glyphicon glyphicon-pencil edit\" data-id=\"".$row['f_id']."\" data-value=\"".$row['form_name']."\"></span></div>
            </div>";
        }
      ?>
